...
tensor-move-clock-scope is a Elixir project for chess and game engines. It focuses on this technical goal: Build an Elixir toolkit that studies clock behavior through layout fixtures, with stable geometry snapshots and no production deployment claims.
