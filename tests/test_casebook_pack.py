"""Regression checks for the tensor-move-clock-scope casebook."""
...
from casebook.harness import assert_expected, tensor_move_clock_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(tensor_move_clock_scope_summary(), assert_expected())
